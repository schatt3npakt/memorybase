...
import { playMaximizeSound, playMinimizeSound, playClickSound, playHoverSound } from '../services/AudioService'
...
<template>
  <div>
    ...
    <div v-if="isOpen" class="modal p-4 w-full max-w-3xl rounded-lg max-h-full overflow-auto">
      <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-5 pt-16 md:pt-0">
        <CustomToggleButton
